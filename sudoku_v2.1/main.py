...
# class CreacioJoc(threading.Thread):
#     def __init__(self):
...
#
#     def run(self):
#         self.sudoku = sudokuMaker.generate_grid()
#         print self.sudoku
#         self.joc = sudokuMaker.generate_game(self.sudoku)
...
class Joc(QtGui.QMainWindow, sudoku.Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.messages.setText('Per comencar a jugar prem el boto NOU JOC.')
    ...
    def generar_joc(self):
        self.messages.setStyleSheet(self.CSS1)
        self.messages.setText(self.GENERANT)
        # fil = CreacioJoc()
        # fil.start()
        # fil.join()
        self.sudoku = sudokuMaker.generate_grid()
